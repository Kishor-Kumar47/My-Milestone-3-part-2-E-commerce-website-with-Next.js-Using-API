...
const page = () => {
  return (
    <main>
      ...
      <section className="bg-gradient-to-t from-black to-gray-700 text-gray-400 body-font relative">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Feel freely Contact Us if you complete Reward requirements and also aother qurrey
            </p>
          </div>
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-amber-600 border-0 py-2 px-8 focus:outline-none hover:bg-amber-700 rounded text-lg">
                  Button
                </button>
              </div>
            </div>
